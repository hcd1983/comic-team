...
- **讀者 Agent** x20（小炎、泡芙、墨子、阿肥、棉花、刀哥、小鹿、嵐嵐、虎爺、蜜蜂、老K、霜霜、阿南、薇薇、拓海、小靈、秋姐、大熊、月月、阿公）：虛擬讀者，依作品 TA 自動推薦 5-7 位組成投票團
- **Gemini 生圖**：透過 MCP tool（gemini-draw）呼叫 Gemini API（gemini-3.1-flash-image-preview）生成圖片，支援 aspectRatio、imageSize、referenceImages

## 目錄結構

```
.claude/agents/     — 素材搜集員、編劇 x3、分鏡師、導演、讀者 x20
.claude/skills/     — create、research、discuss、character-design、storyboard、draw、vote
config/             — 讀者標籤（virtual-readers.json）、TA 預設（ta-presets.json）
